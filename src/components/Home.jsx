        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">Bolsa de Trabajo  </h1> <span className='italic  text-2xl text-gray-600'>Catamarca</span>
              <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">plataforma que conecta a personas que buscan empleo en la provincia de Catamarca, es de libre acceso para todo el publico en general.</p>
